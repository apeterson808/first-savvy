...
import { CreateRuleDialog } from '../rules/CreateRuleDialog';
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Transaction Rules</h2>
          <p className="text-slate-500 text-sm mt-1">Automatically categorize and tag transactions</p>
        </div>
