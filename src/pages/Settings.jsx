...
import { User, Lock, Settings as SettingsIcon, Bell, Shield, Layers } from 'lucide-react';
...
import AccountClassificationsTab from '../components/settings/AccountClassificationsTab';
      ...
      <Tabs defaultValue="profile" className="space-y-4">
        <TabsList className="grid w-full grid-cols-6 lg:w-auto lg:inline-grid">
          ...
          <TabsTrigger value="classifications" className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline">Account Types</span>
          </TabsTrigger>
