...
export default function Login() {
  ...
  const handleToggleChildAccess = () => {
    setIsChildAccess(!isChildAccess);
    setIsLogin(false);
    setError('');
    setEmail('');
    setPassword('');
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl text-center">
            {isChildAccess ? 'View Child Profile' : (isLogin ? 'Welcome back' : 'Create an account')}
          </CardTitle>
          <CardDescription className="text-center">
            {isChildAccess
              ? 'Sign in to view and manage child profiles'
              : (isLogin
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={loading}>
              {loading ? (
                ...
                isChildAccess ? 'View Child Profiles' : (isLogin ? 'Sign In' : 'Sign Up')
              )}
            </Button>
          </form>
