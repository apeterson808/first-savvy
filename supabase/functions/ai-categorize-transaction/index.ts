...
function suggestChartAccountFallback(description: string, amount: number | undefined, chartAccounts: ChartAccount[]): ChartAccount | null {
  ...
  const patterns = [
    ...
    { keywords: ['comcast', 'spectrum', 'cox internet', 'xfinity', 'centurylink', 'frontier internet'], categoryNames: ['internet', 'utilities'] },
    { keywords: ['verizon wireless', 'att wireless', 't-mobile', 'sprint', 'mint mobile', 'cricket wireless', 'boost mobile'], categoryNames: ['phone', 'utilities'] },
    { keywords: ['water bill', 'water utility', 'gas bill', 'electric', 'power company', 'energy bill', 'sewer', 'waste management', 'pge', 'duke energy', 'southern company', 'con edison', 'dominion energy'], categoryNames: ['utilities'] },
