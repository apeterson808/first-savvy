/*
  # Fix Journal Entry Trigger - Correct Credit Card Payment Column Name

  1. Changes
    - Fix `auto_create_journal_entry_from_transaction()`: Use `cc_payment_pair_id` instead of `credit_card_payment_id`
    - The column was renamed but the function was not updated

  2. Security
    - No security changes, just column name correction
*/
...
BEGIN
  ...
  INSERT INTO journal_entries (
    ...
    CASE
      ...
      WHEN NEW.cc_payment_pair_id IS NOT NULL THEN 'cc_payment'
      ELSE 'transaction'
    END,
    CASE
