/*
  # Reverse Register Order - Newest First

  1. Change
    - Update ORDER BY to show newest entries first (DESC)
    - Running balance still calculates from oldest to newest (correct)
    - Display shows newest at top (like QuickBooks)

  2. Implementation
    - Change final ORDER BY from ASC to DESC
    - Keep window function ordering as is (oldest to newest for balance)
*/
