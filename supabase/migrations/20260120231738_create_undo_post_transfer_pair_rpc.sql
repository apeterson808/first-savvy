/*
  # Create undo_post_transfer_pair RPC (SAFETY NIT 2)

  ## Summary
  Unposts a transfer pair atomically with strict validation.
  
  ## Key Safety Checks (SAFETY NIT 2)
  ...
  7. Optional: blocks reversing a reversal (entry_type='reversal')
  
  ## Parameters
  - p_pair_id: UUID of the transfer pair
...
'Unposts a transfer pair atomically with strict validation: exactly 2 txns, same profile, atomic state, shared JE. Creates one reversal entry.';
