/*
  # Fix Date Column Reference in Journal Entry Creation Trigger
  
  ## Problem
  The auto_create_journal_entry_from_transaction trigger uses NEW.transaction_date
  but the transactions table column is named 'date', not 'transaction_date'.
  
  ## Fix
  Update the trigger function to use NEW.date instead of NEW.transaction_date.
*/
