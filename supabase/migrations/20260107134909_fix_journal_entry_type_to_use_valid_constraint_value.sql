/*
  # Fix Journal Entry Type to Use Valid Constraint Value
  
  ## Problem
  The auto_create_journal_entry_from_transaction trigger uses 'transaction' as entry_type,
  but the valid_entry_type constraint only allows:
  - opening_balance, adjustment, transfer, reclassification, closing, depreciation, accrual, reversal
  
  ## Fix
  Change the trigger to use 'adjustment' instead of 'transaction' for regular transactions.
*/
