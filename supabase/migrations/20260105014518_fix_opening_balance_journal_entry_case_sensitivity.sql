/*
  # Fix Opening Balance Journal Entry Case Sensitivity

  1. Issue
    - Function was checking for 'Asset' and 'Liability' (capitalized)
    - Database stores class as 'asset' and 'liability' (lowercase)
    - This caused journal entries to fail when creating accounts

  2. Fix
    - Convert account class to lowercase for comparison
    - This ensures compatibility with database values
*/
