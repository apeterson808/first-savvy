/*
  # Fix Journal Entry Trigger Column Name
  
  ## Overview
  The trigger references NEW.transaction_date but the column is actually named 'date'.
  This causes inserts to fail with "record 'new' has no field 'transaction_date'"
  
  ## Changes
  - Update trigger function to use NEW.date instead of NEW.transaction_date
*/
