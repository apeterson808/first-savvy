/*
  # Fix Ambiguous actor_display_name Column Reference

  ## Problem
  The entry_actors CTE used `actor_display_name` as both a column alias and a
  selected column from audit_logs. PL/pgSQL treats this as ambiguous and throws
  error 42702. Fix: alias the column explicitly as `ea_actor_name` inside the
  subquery so there is no naming conflict.
*/
