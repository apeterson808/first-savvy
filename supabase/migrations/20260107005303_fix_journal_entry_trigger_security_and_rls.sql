/*
  # Fix Journal Entry Trigger Security and RLS Issues

  1. Changes
    - Add SET search_path = public to auto_create_journal_entry_from_transaction function
    - This prevents search_path attacks and ensures predictable execution
    - Fixes RLS issues when trigger inserts journal entries
