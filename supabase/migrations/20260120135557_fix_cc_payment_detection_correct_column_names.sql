/*
  ...
  1. Changes
    - Fix all column references to match current transactions table schema
  ...
  2. Purpose
    - Fix SQL errors preventing credit card payment detection from running
    - Ensure function works with current database schema
*/
