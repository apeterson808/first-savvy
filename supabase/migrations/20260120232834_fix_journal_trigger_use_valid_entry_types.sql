/*
  # Fix Journal Entry Trigger - Use Valid Entry Types

  1. Changes
    - Fix `auto_create_journal_entry_from_transaction()`: Use valid entry types for counters
    - Map 'transaction' → 'adjustment' (regular transactions)
    - Map 'cc_payment' → 'adjustment' (credit card payments)
    - Keep 'transfer' → 'transfer'

  2. Security
    - No security changes, just entry type mapping
*/
