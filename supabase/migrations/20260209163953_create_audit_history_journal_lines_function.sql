/*
  # Create Audit History Journal Lines Function

  1. New Function
    - `get_account_audit_history_paginated` - Returns ALL journal entries including reversals
    - Shows complete audit trail with entry type and reversal relationships
    - Includes metadata about which entries are reversed or are reversals
    
  2. Features
    - Shows all entries (no filtering by reversal status)
    - Returns entry_type (adjustment, transfer, credit_card_payment, reversal)
    - Returns reversal relationship data
    - Chronological order (newest first) like the register
*/
