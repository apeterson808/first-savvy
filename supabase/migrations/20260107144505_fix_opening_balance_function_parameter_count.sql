/*
  # Fix Opening Balance Journal Entry Function

  1. Issue Fixed
    - Remove invalid 'posted' parameter from create_journal_entry call
    - The create_journal_entry function only accepts 7 parameters, not 8
    
  2. Changes
    - Updated function call to remove the status parameter
    - Function now correctly calls create_journal_entry with proper signature
    
  3. Impact
    - Fixes error when creating opening balance journal entries
    - No behavioral changes - opening balance entries are always created as system entries
*/
