/*
  # Lower Transfer Auto-Match Threshold

  1. Updates
    - Lower auto-match threshold from 95% to 70% for more practical matching
    - Same-day transfers with matching amounts should auto-match
*/
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      -- If confidence is 70% or higher, automatically match (lowered from 95%)
