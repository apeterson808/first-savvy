/*
  # Fix Journal Trigger - Use NULL Instead of Zero

  1. Issue
    - The trigger inserts 0 for unused debit/credit amounts
    - The check constraint requires NULL (not zero) for the unused amount
    - Constraint: debit XOR credit (one must be NULL, one must have value)

  2. Changes
    - Replace all "0" with "NULL" for unused debit_amount/credit_amount
    - This satisfies the line_has_debit_or_credit constraint
*/
