/*
  # Fix Ambiguous Class Column Reference

  1. Changes
    - Fix the ambiguous "class" column reference in get_account_journal_lines_paginated
    - Properly qualify the column with the table name

  2. Details
    - The SELECT statement was trying to select "class" but both user_chart_of_accounts 
      and chart_of_accounts_templates have this column
    - Now explicitly uses user_chart_of_accounts.class
*/
